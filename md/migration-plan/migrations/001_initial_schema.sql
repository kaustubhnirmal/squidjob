...
-- Description: Initial database schema for Tender Management System
-- Version: 1.0.0
-- Created: 2025-07-29

-- Create core tables for the Tender Management System
...
ALTER TABLE companies ADD CONSTRAINT chk_company_type CHECK (company_type IN ('dealer', 'oem', 'vendor', 'contractor'));
